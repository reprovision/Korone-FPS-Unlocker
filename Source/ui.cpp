...
#ifdef _WIN64
	SetConsoleTitleA("Pekora FPS Unlocker (64-bit) Console");
#else
	SetConsoleTitleA("Pekora FPS Unlocker (32-bit) Console");
#endif
...
{	
	...
	UI::Window = CreateWindow("RFUClass", "Pekora FPS Unlocker", 0, 0, 0, 0, 0, NULL, NULL, instance, NULL);
	if (!UI::Window)
		return 0;
	...
	strcpy_s(NotifyIconData.szTip, "Pekora FPS Unlocker");
